	...
	<table border="1" align="center" width="35%" cellpadding="1.5" cellspacing="0" border="white">
		...
		<tbody>
			...
			for ($i=0; $row=$result->fetch(); $i++) { 
				...
				?>
				<tr>
            <td colspan="6" align="center"bgcolor="yellow"><b><center><input type="submit" class="btn-warning"name="report" value="Delete" onclick="return confirm('Are you sure you want to delete thise rows?')" </input></td></center></b>
          </td>
        </tr>
		</tbody>
	</table>
