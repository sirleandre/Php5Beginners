...
$mail->Username = 'duduwamama@gmail.com';                // SMTP username
$mail->Password = 'dusabimana1';                  // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable encryption, 'ssl' also accepted
$mail->From = ' duduwamama@gmail.com ';
$mail->FromName = 'duduwamama@gmail.com ';
$mail->AddAddress('dusamine@gmail.com', 'Josh Adams');  // Add a recipient
$mail->AddAddress('dusamine@gmail.com');               // Name is optional
$mail->IsHTML(true);                                  // Set email format to HTML
$mail->Subject = 'Here is the subject';
$mail->Body    = 'This is the HTML message body <strong>in bold!</strong>';
$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
$mail->addAttachment('PHPMAILER.pptx');
// $mail->addBCC('superitlevel1@gmail.com');// Blind copy carbon
$mail->addCC('janvierechris@gmail.com');  
